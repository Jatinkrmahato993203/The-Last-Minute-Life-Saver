    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          variant === "ghost" && "bg-transparent text-ink hover:bg-ink/5 border-transparent",
          variant === "link" && "bg-transparent text-ink underline decoration-amber decoration-2 underline-offset-4 hover:text-ink/80 px-0 h-auto border-transparent",
          className
        )}
        {...props}
      />
